...
var Particle = function () {
  function Particle(rect, rectIndex, particleIndex) {
...
var o = {
  name: "dmss",
  elements: ["circleD", "circleM", "circleS", "circleS2", "rectD", "rectM", "rectS", "rectS2", "charD", "charM", "charS", "charS2", "chars", "rects", "particles", "pContainer0", "pContainer1", "pContainer2", "pContainer3"],
  lists: [],
  data: {
    // types: { section: { value: { } } },
    ticker: 0,
  ...
  createSVG: function createSVG(id) {
  ...
  getRectsTl: function getRectsTl() {
    ...
    tl.add("anticipation", 0).to([group, particles], 0.8, { rotation: -5, ease: Power3.easeInOut }, "anticipation").staggerTo(rects, 0.8, { cycle: { x: o.data.positions.rectAnt.x, y: o.data.positions.rectAnt.y }, scale: 0.9, ease: Power3.easeInOut }, 0, "anticipation").add("spin").to([group, particles], 1.3, { rotation: 315, ease: Power4.easeInOut }, "spin").add("expand", "anticipation =+1.3").staggerTo(rects, 0.8, { cycle: { x: o.data.positions.rectExp.x, y: o.data.positions.rectExp.y }, scale: 0.6, ease: Back.easeIn.config(5) }, 0, "expand").set(particles, { autoAlpha: 1 }, "expand =+0.5").add("idle", "spin =+1.3").to([group, particles], 5, { rotation: "-=15", ease: Linear.easeNone }, "idle").staggerTo(rects, 1, { scale: 0.59, ease: Power1.easeInOut }, 0, "idle").staggerTo(rects, 0.5, { scale: 0.65, ease: Power2.easeIn }, 0, "idle =+1").staggerTo(rects, 0.5, { scale: 0.63, ease: Power1.easeOut }, 0, "idle =+1.5").staggerTo(rects, 1, { scale: 0.59, ease: Power1.easeInOut }, 0, "idle =+2.5").staggerTo(rects, 0.5, { scale: 0.65, ease: Power2.easeIn }, 0, "idle =+3.5").staggerTo(rects, 1, { scale: 0.6, ease: Power1.easeOut }, 0, "idle =+4").staggerTo(o.data.scales.particles, 0.4, { value: 1, ease: Power1.easeInOut, repeat: 1, yoyo: true }, 0.05, "idle =+1.15").staggerTo(o.data.scales.particles, 0.4, { value: 1, ease: Power1.easeInOut, repeat: 1, yoyo: true }, 0.05, "idle =+3.75").add("contraction", "idle =+5").to([group, particles], 0.8, { rotation: 360, ease: Power4.easeInOut }, "contraction").to(particles, 0, { autoAlpha: 0 }, "contraction =+0.4").staggerTo(rects, 0.7, { x: 0, y: 0, scale: 1, ease: Back.easeOut.config(2) }, 0, "contraction").set([group, particles], { rotation: 0 });
  ...
  getCharsTl: function getCharsTl() {
    ...
    tl.add("anticipation").to(group, 0.8, { rotation: -5, ease: Power3.easeInOut }, "anticipation").staggerTo(chars, 0.8, { cycle: { x: o.data.positions.charAnt.x, y: o.data.positions.charAnt.y }, scale: 0.9, ease: Power3.easeInOut }, 0, "anticipation").add("spin").to(group, 1.3, { rotation: "+=355", ease: Power4.easeInOut }, "spin").add("contraction", "spin =+0.5").staggerTo(chars, 0.8, { cycle: { x: o.data.positions.charCont.x, y: o.data.positions.charCont.y }, ease: Back.easeOut.config(1) }, 0, "contraction").staggerTo(chars, 0.4, { scale: 0.4, ease: Power4.easeInOut }, 0, "contraction").staggerTo(chars, 0.3, { cycle: { morphSVG: o.data.paths.morph } }, 0, "contraction").add("idle").staggerTo(chars, 1.25, { scale: 0, ease: Power1.easeInOut, repeat: 3, yoyo: true }, 0.15, "spin =+0.9") // 5.45 duration
    .to(group, 1.25, { scale: 1.5, ease: Power1.easeInOut, repeat: 3, yoyo: true }, "spin =+0.9").to(group, 5, { rotation: "+=200", ease: Linear.easeNone }, "idle").add("morphBack", "idle =+5").to(group, 0.5, { rotation: 720, ease: Power1.easeInOut }, "morphBack").staggerTo(chars, 0.5, { cycle: { morphSVG: o.data.paths.original }, rotation: 0 }, 0, "morphBack =+0.1").staggerTo(chars, 0.5, { scale: 1, ease: Power4.easeInOut }, 0, "morphBack =+0.2").staggerTo(chars, 0.5, { x: 0, y: 0, ease: Power4.easeInOut }, 0, "morphBack =+0.2").set(group, { rotation: 0 });

    return tl;
  },
  recordValues: function recordValues() {
