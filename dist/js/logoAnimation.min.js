...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a = function a(_a, b, c) {
    var d = _a.type,
        e = _a.setRatio,
        f = b._tween,
        g = b._target;_a.type = 2, _a.m = c, _a.setRatio = function (b) {
      var h,
          i,
          j,
          k = 1e-6;if (1 !== b || f._time !== f._duration && 0 !== f._time) {
        if (b || f._time !== f._duration && 0 !== f._time || f._rawPrevTime === -1e-6) {
          if (h = _a.c * b + _a.s, _a.r ? h = Math.round(h) : k > h && h > -k && (h = 0), d) {
            if (1 === d) {
              for (i = _a.xs0 + h + _a.xs1, j = 1; j < _a.l; j++) {
                i += _a["xn" + j] + _a["xs" + (j + 1)];
              }_a.t[_a.p] = c(i, g);
            } else -1 === d ? _a.t[_a.p] = c(_a.xs0, g) : e && e.call(_a, b);
          } else _a.t[_a.p] = c(h + _a.xs0, g);
        } else 2 !== d ? _a.t[_a.p] = c(_a.b, g) : e.call(_a, b);
      } else if (2 !== d) {
        if (_a.r && -1 !== d) {
          if (h = Math.round(_a.s + _a.c), d) {
            if (1 === d) {
              for (i = _a.xs0 + h + _a.xs1, j = 1; j < _a.l; j++) {
                i += _a["xn" + j] + _a["xs" + (j + 1)];
              }_a.t[_a.p] = c(i, g);
        ...
        } else _a.t[_a.p] = c(_a.e, g);
      } else e.call(_a, b);
    };
  },
      b = function b(_b, c) {
    for (var d = c._firstPT, e = _b.rotation && -1 !== c._overwriteProps.join("").indexOf("bezier"); d;) {
      "function" == typeof _b[d.p] ? a(d, c, _b[d.p]) : e && "bezier" === d.n && -1 !== d.plugin._overwriteProps.join("").indexOf("rotation") && (d.data.mod = _b.rotation), d = d._next;
    }
  },
      c = _gsScope._gsDefine.plugin({ propName: "modifiers", version: "0.0.2", API: 2, init: function init(a, b, c) {
      return this._tween = c, this._vars = b, !0;
    }, initAll: function initAll() {
      for (var a, c, d = this._tween, e = this._vars, f = this, g = d._firstPT; g;) {
        c = g._next, a = e[g.n], g.pg ? "css" === g.t._propName ? b(e, g.t) : g.t !== f && (a = e[g.t._propName], g.t._mod("object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? a : e)) : "function" == typeof a && (2 === g.f && g.t ? g.t._applyPT.m = a : (this._add(g.t, g.p, g.s, g.c, a), c && (c._prev = g._prev), g._prev ? g._prev._next = c : d._firstPT === g && (d._firstPT = c), g._next = g._prev = null, d._propLookup[g.n] = f)), g = c;
      }return !1;
    } }),
      d = c.prototype;d._add = function (a, b, c, d, e) {
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a = Math.PI / 180,
    ...
    var e,
      ...
      J = _gsScope._gsDefine.plugin({ propName: "morphSVG", API: 2, global: !0, version: "0.8.5", init: function init(a, b, c) {
      var d, f, g, i, j;return "function" != typeof a.setAttribute ? !1 : (d = a.nodeName.toUpperCase(), j = "POLYLINE" === d || "POLYGON" === d, "PATH" === d || j ? (f = "PATH" === d ? "d" : "points", ("string" == typeof b || b.getBBox || b[0]) && (b = { shape: b }), i = H(b.shape || b.d || b.points || "", "d" === f, a), j && e.test(i) ? (h("WARNING: a <" + d + "> cannot accept path data. " + I), !1) : (i && (this._target = a, a.getAttributeNS(null, "data-original") || a.setAttributeNS(null, "data-original", a.getAttribute(f)), g = this._addTween(a, "setAttribute", a.getAttribute(f) + "", i + "", "morphSVG", !1, f, "object" == _typeof(b.precompile) ? function (a) {
        a[0] = b.precompile[0], a[1] = b.precompile[1];
      } : "d" === f ? A(b.shapeIndex, b.map || J.defaultMap, b.precompile) : E(b.shapeIndex)), g && (this._overwriteProps.push("morphSVG"), g.end = i, g.endProp = f)), !0)) : (h("WARNING: cannot morph a <" + d + "> SVG element. " + I), !1));
    }, set: function set(a) {
...
var o = {
  ...
  getMasterTl: function getMasterTl() {
    var tl = new TimelineMax({ paused: true, onComplete: function onComplete() {
        o.data.playing = false;
      } });
    var rectsTimeline = o.getRectsTl();
    var charsTimeline = o.getCharsTl();

    tl.call(o.emit, ["logoMotion", "expansion"], this, 0).add(rectsTimeline, 0).add(charsTimeline, 0).call(o.emit, ["logoMotion", "contraction"], this, 7.2);
